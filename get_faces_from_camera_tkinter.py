...
detector = dlib.get_frontal_face_detector() # responsible for detecting the face

#tkinter start - windows, names, lebels
class Face_Register:
    def __init__(self):
        ...
        self.cap = cv2.VideoCapture(0)  # Get video stream from camera. This is where it is getting tthe frame

        # self.cap = cv2.VideoCapture("test.mp4")   # Input local video

    #  Delete old face folders, basically clears the previous data
